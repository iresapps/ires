...
public class ContactActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Get division names
        divisions = new ArrayList<>(Arrays.asList(getResources().getStringArray(R.array.division_list)));

        CustomAdapter customAdapter = new CustomAdapter(ContactActivity.this, divisions, R.drawable.philip);
